from app.models.organization_permission_models import OrganizationCheckPermissionRequest
...
async def register_organization(
    ...
    try:
        ...
        if org_data.password and org_data.email:
            ...
            org_user = await org_service.invite_user(
                str(org["id"]), user["email"], str(admin_id)
            )
...
@router.put(
    "/{org_id}/users/{target_user_id}/role", response_model=OrganizationUserResponse
)
async def update_organization_user_role(
    ...
    try:
        ...
        result = await org_service.update_user_role(
            org_id, target_user_id, update_data.role_id
        )
...
@router.put(
    "/{org_id}/users/{target_user_id}/phone-number", response_model=Dict[str, Any]
)
async def update_organization_user_phone_number(
    ...
    try:
        ...
        result = await org_service.update_user_phone_number(
            org_id, user_id, data.phone_number
        )
